...
public class MainFrame extends MainTab {
  ...
  void fsZelda(){
    ...
    pbLinkedMemory.ccWriteBit
      (0, 0x1, pbElementCoordinator.cmToggleSW.ccIsPressed());
    
    //-- recv
    pbElementCoordinator.cmToggleSW.ccSetActivity
      (pbLinkedMemory.ccReadBit(4, 0x1));
