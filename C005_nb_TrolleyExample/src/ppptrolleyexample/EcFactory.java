...
public class EcFactory {
  ...
  private static final int
    ...
    C_BUTTON_FILL_PRESS   =0xFF99BB99,
  ...
  private static class EcTip{
    ...
    EcTip(String pxTip){
      ...
      cmTipH=C_TEXT_HEIGHT+2;
      for(char it:pxTip.toCharArray()){if(it=='\n'){cmTipH+=C_TEXT_HEIGHT+2;}}
    }//+++
  }//***
  ...
  static class EcElement extends EcRect{
    ...
    public EcElement() {
      ...
      cmTagAlign='x';
      cmIsEnabled=true;cmIsVisible=true;
    }//+++
    //--
    //-- ** modifier
    public final void ccSetText(String pxText){cmText=pxText;}//+++
    public final void ccSetName(String pxName){cmName=pxName;}//+++
    public final void ccSetNameAlign(char pxMode_ablr){cmTagAlign=pxMode_ablr;}//+++
    public final void ccSetID(int pxID){cmID=pxID;}//+++
    public final void ccSetColor(int pxOn, int pxOff){cmOnColor=pxOn;cmOffColor=pxOff;}//+++
    public final void ccSetStatus(boolean pxAct){cmAct=pxAct;}
    public final void ccSetAct(boolean pxAct){cmAct=pxAct;}//+++
    //--
    ...
    //-- ** teller
    public final boolean ccIsAct(){return cmAct;}//+++
  ...
  static class EcButton extends EcElement{
    ...
    @Override void ccUpdate() {
      ...
      pbOwner.fill(ccIsMouseOver()?
        (pbOwner.mousePressed?C_BUTTON_FILL_PRESS:C_BUTTON_FILL_OVER)
  ...
  static class EcLamp extends EcElement{
    public EcLamp(String pxName, int pxW, int pxH, int pxID) {
      super();
      ccSetID(pxID);
      ccTakeKey(pxName);
  ...
  static class EcTextBox extends EcElement{
    ...
    public EcTextBox(String pxName, int pxW, int pxH, int pxID) {
      super();
      super.ccSetID(pxID);
  ...
  static class EcGauge extends EcElement {
    ...
    protected int cmPerHalfByte;
    public EcGauge(String pxName, int pxW, int pxH, int pxID) {
      super();
      ccSetID(pxID);
      ccTakeKey(pxName);
      ccSetSize(pxW, pxH);
    ...
    final void ccSetPercentage(float pxZeroToOne){
      cmPerHalfByte=ceil(127f*pxZeroToOne)&127;
    }//+++
    final void ccSetPercentage(int pxMaxAs_127){cmPerHalfByte=pxMaxAs_127&127;}//+++
    ...
    @Override void ccUpdate() {
      int lpLength=((cmIsVertical?cmH:cmW)*cmPerHalfByte)/127;
