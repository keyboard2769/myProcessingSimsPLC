...
public class MainTab extends PApplet{
  ...
  class EcCoordinator extends EcFactory.EcBaseCoordinator{
    ...
    EcFactory.EcLamp cmBlinkPL;
    
    public EcCoordinator() {
      super();
      
      cmBlinkPL=new EcFactory.EcLamp("blink!", 16, 16);
      cmBlinkPL.ccSetLocation(160-8, 120-8);
      cmBlinkPL.ccSetNameAlign('a');
      ccAddElement(cmBlinkPL);
  ...
  class ZcCPUZero extends ZcFactory.ZcPLC{
    ...
    ZcFactory.ZiTask cmDefaultLadder = new ZcFactory.ZiTask() {
      @Override public void ccScan() {
        ...
        cmLinkedMemory.ccWriteBit(0, 0x0, cmOnesecFlicker.ccIsUP());
